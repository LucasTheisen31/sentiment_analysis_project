...
| [sentiment_analysis_project/README.md](https://github.com/LucasTheisen31/sentiment_analysis_project/blob/main/sentiment_analysis_project/README.md) | Documentação técnica do sistema (deploy com Docker Compose - API e frontend Flutter web) (este arquivo) |
...
| [sentiment_analysis_project/web/README.md](https://github.com/LucasTheisen31/sentiment_analysis_project/blob/main/sentiment_analysis_project/web/README.md) | Documentação do frontend Flutter web |
